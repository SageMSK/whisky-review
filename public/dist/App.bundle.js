...
function ajaxFavoriteReview(e) {
  ...
  _axios2.default.post(this.action) // this = form, action = link
  .then(function (res) {
    // favorite = name attr
    // toggle the active class
    var isFavorited = _this.favorite.classList.toggle('favorite-button--favorited');
  }).catch(function (err) {
    return console.error(err);
  });
}

exports.default = ajaxFavoriteReview;
...
var _favorite = __webpack_require__(10);
...
// need to use 'on'
// Import our CSS/SASS
var favoriteForm = (0, _bling.$)('form.review__favoriteForm');
// import './modules/deleteForm';
// import ajaxDeleteComment from './modules/deleteComment';

favoriteForm.on('submit', _favorite2.default);
